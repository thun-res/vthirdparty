...
#define ALOGE(LOG_TAG, ...) ((void)__android_log_write(ANDROID_LOG_ERROR, LOG_TAG, __VA_ARGS__))
#ifndef LOGE
#define LOGE ALOGE
#endif
...
#define ALOGW(LOG_TAG, ...) ((void)__android_log_write(ANDROID_LOG_WARN, LOG_TAG, __VA_ARGS__))
#ifndef LOGE
#define LOGW ALOGW
#endif
...
#define ALOGI(LOG_TAG, ...) ((void)__android_log_write(ANDROID_LOG_INFO, LOG_TAG, __VA_ARGS__))
#ifndef LOGE
#define LOGI ALOGI
#endif
...
#define ALOGD(LOG_TAG, ...) ((void)__android_log_write(ANDROID_LOG_DEBUG, LOG_TAG, __VA_ARGS__))
#ifndef LOGE
#define LOGD ALOGD
#endif
...
#define ALOGV(LOG_TAG, ...) ((void)__android_log_write(ANDROID_LOG_VERBOSE, LOG_TAG, __VA_ARGS__))
#ifndef LOGE
#define LOGV ALOGV
#endif
