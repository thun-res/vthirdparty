...
public class Fdbus
{
    ...
    public final static int FDB_MT_SET_EVENT        = 11;
    public final static int FDB_MT_MAX              = 11;
    ...
    // Fdbus QOS
    public final static int FDB_QOS_LOCAL                   = 0;
    public final static int FDB_QOS_RELIABLE                = 1;
    public final static int FDB_QOS_BEST_EFFORTS            = 2;
    public final static int FDB_QOS_SECURE_RELIABLE         = 3;
    public final static int FDB_QOS_SECURE_BEST_EFFORTS     = 4;
    public final static int FDB_QOS_TRY_SECURE_RELIABLE     = 5;
    public final static int FDB_QOS_TRY_SECURE_BEST_EFFORTS = 6;
    public final static int FDB_QOS_INVALID                 = 7;
