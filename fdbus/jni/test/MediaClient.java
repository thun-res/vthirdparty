...
public class MediaClient 
{
    private class FdbusMediaClient extends TimerTask implements FdbusClientListener
    {
        ...
        public void onOnline(int sid, int qos)
        {
            System.out.println(mClient.endpointName() + ": onOnline is received: " + sid + ", qos: " + qos);
            ArrayList<SubscribeItem> subscribe_items = new ArrayList<SubscribeItem>();
            subscribe_items.add(SubscribeItem.newEvent(NFdbExample.FdbMediaSvcMsgId.NTF_ELAPSE_TIME_VALUE, "my_topic"));
        ...
        public void onOffline(int sid, int qos)
        {
            System.out.println(mClient.endpointName() + ": onOffline is received: " + sid + ", qos: " + qos);
        }
        ...
        public void run()
        {
            ...
            {
                FdbusMessage msg = mClient.invokeSync(NFdbExample.FdbMediaSvcMsgId.REQ_METADATA_VALUE, builder);
            ...
            else
            {
                ...
                else
                {
                    ...
                    mClient.invokeAsync(NFdbExample.FdbMediaSvcMsgId.REQ_METADATA_VALUE, builder, usr_data);
                }
            }
            mClient.invokeAsync(NFdbExample.FdbMediaSvcMsgId.REQ_RAWDATA_VALUE, null, null);
            mTimerRunning = false;
        }
    }
