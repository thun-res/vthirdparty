...
public class AFComponentClient
{
    ...
    public static void main(String[] args)
    {
        ...
        for (String arg : args)
        {
            ...
            event_list.add(SubscribeItem.newAction(NFdbExample.FdbMediaSvcMsgId.NTF_ELAPSE_TIME_VALUE, "my_topic",
                    new FdbusAppListener.Action(){
                        public void handleMessage(FdbusMessage msg)
                        {
                            try {
            ...
            FdbusClient client = component.queryService(arg, event_list,
                ...
                {
                    public void onConnectionStatus(int sid, boolean is_online, boolean first_or_last, int qos)
                    {
                        System.out.println(arg + ": onConnectionStatus - session: " + sid +
                                            ", is_online: " + is_online +
