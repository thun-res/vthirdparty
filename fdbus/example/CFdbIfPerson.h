...
class CCar : public ipc::fdbus::IFdbParcelable
{
public:
...
class CPerson : public ipc::fdbus::IFdbParcelable
{
public:
    void serialize(ipc::fdbus::CFdbSimpleSerializer &serializer) const
    {
    ...
    int32_t mSalary;
    std::string mAddress;
    ipc::fdbus::CFdbParcelableArray<CCar> mCars;
    ipc::fdbus::CFdbParcelableArray<ipc::fdbus::CFdbByteArray<20>> mPrivateInfo;
